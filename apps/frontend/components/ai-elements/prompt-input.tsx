...
// Derive the onSelect event type from DropdownMenuItem so it matches the
// underlying primitive (base-ui in this repo's shadcn setup), not a hardcoded DOM Event.
...
// base-ui's PreviewCard.Root does not accept open/close delay props (delay is
// configured on the Trigger in this version), so this wrapper just forwards props.
